...
/usr/bin/mysqldump -u root --password=nahBabuLY23tublaka7vZopu --all-databases --events --ignore-table=mysql.event --port=3306  > /home/dinky/smart/$filename.sql 
/usr/bin/mysqldump -u root --password=nahBabuLY23tublaka7vZopu --all-databases --events --ignore-table=mysql.event --port=13306  > /home/dinky/smart/$filename-local.sql 
